...
const PwReset = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {!successfulCreation && (
        <>
          <TextInput autoCapitalize="none" placeholder="xyx@xyz.com" value={emailAddress} placeholderTextColor={"gray"} onChangeText={setEmailAddress} style={styles.inputField} />
